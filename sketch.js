...
let gravity = 100; //attracts or repels from mouse  --> negative number attracts, positive number repels
  

// empty arrays for OOP
var buttons = [];
var mouseloc = [];
...
//concept for joinParticles() adapted from https://p5js.org/examples/simulate-particles.html
  ...
  //distSq, gravity, mag concept use adapted from various online sources
  update() {  
