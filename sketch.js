...
// speed of a particle in both the co-ordinates axes.
  constructor(){
    ...
    // my additions to Particle class
...
// between particles which are less than a certain distance apart
  ...
  // my addition to particle system example code
  // example reference: https://p5js.org/reference/#/p5.Vector/sub
  repelParticle(mousePos) {
    let gravity = 100;
    let particleForce = p5.Vector.sub(mousePos, this.pos);
    //https://p5js.org/reference/#/p5.Vector/magSq
    let distanceSquared = particleForce.magSq();
  }
}
...
function draw() {
  ...
  for(let i = 0;i<particles.length;i++) {
    ...
    // my adaditions to particle functions begin here
    particles[i].repelParticle(mousePos);
  }
